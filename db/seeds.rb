...
# 1 user, 8 leads:
alicia = User.create(name: "Alicia Bolton", customer: qpf, email: "alicia.bolton@hotmail.com", password: "123456", photo: "QT_0063.jpg", rank: nil)
...
# user with no leads
taryn = User.create(name: "Taryn Baron", customer: dupont, email: "taryn.baron@hotmail.com", password: "123456", photo: "QS_0015.jpg", rank: nil)

# user with accepted leads but no closures
nicole = User.create(name: "Nicole Smith", customer: dupont, email: "nicole.smith@hotmail.com", password: "123456", photo: "QS_0067.jpg", rank: nil)
5.times do
  lead_name = Faker::Name.first_name
  # email_name = lead_name.gsub!(/\s/, '.')
...
mike = User.create(name: "Mike Morneau", customer: dupont, email: "mike.morneau@hotmail.com", password: "123456", photo: "QS_0082.jpg", rank: nil)
mike_leads = []
8.times do
  lead_name = Faker::Name.first_name
  # email_name = lead_name.gsub!(/\s/, '.')
...
# user with accepted leads: 2 lost, 2 settled, 2 accepted
christie = User.create(name: "Christie Clark", customer: dupont, email: "christie.clark@hotmail.com", password: "123456", photo: "QS_0123.jpg", rank: nil)
christie_leads = []
8.times do
  lead_name = Faker::Name.first_name
  # email_name = lead_name.gsub!(/\s/, '.')
...
# user with accepted leads: 2 lost, 2 settled, 2 accepted
john = User.create(name: "John Jones", customer: qpf, email: "john.jones@hotmail.com", password: "123456", photo: "QS_0061.jpg", rank: nil)
john_leads = []
8.times do
  lead_name = Faker::Name.first_name
  # email_name = lead_name.gsub!(/\s/, '.')
...
# user with accepted leads: 2 lost, 2 settled, 2 accepted
jim = User.create(name: "Jim Krats", customer: qpf, email: "jim.krats@hotmail.com", password: "123456", photo: "QS_0039.jpg", rank: nil)
jim_leads = []
8.times do
  lead_name = Faker::Name.first_name
  # email_name = lead_name.gsub!(/\s/, '.')
...
# user with accepted leads: 2 lost, 2 settled, 2 accepted
chris = User.create(name: "Chris Columb", customer: qpf, email: "chris.columb@hotmail.com", password: "123456", photo: "QS_0028.jpg", rank: nil)
chris_leads = []
8.times do
  lead_name = Faker::Name.first_name
  chris_lead = Lead.new(
...
# user with accepted leads: 2 lost, 2 settled, 2 accepted
nathan = User.create(name: "Nathan Bates", customer: qpf, email: "nathan.bates@hotmail.com", password: "123456", photo: "Q_0008.jpg", rank: nil)
nathan_leads = []
8.times do
  lead_name = Faker::Name.first_name
  # email_name = lead_name.gsub!(/\s/, '.')
...
christopher = User.create(name: "Chris Hutchinson", customer: qpf, email: "leadmailertest@gmail.com", password: "123456", photo: "chrissuit.jpg", rank: nil)
2.times do
  lead_name = Faker::Name.first_name
  # email_name = lead_name.gsub!(/\s/, '.')
